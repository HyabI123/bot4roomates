...
import dotenv from 'dotenv';              // dotenv to securely load environment variables
import { Client, GatewayIntentBits } from 'discord.js'; // Discord.js to run the bot

// 2️⃣ Load environment variables
dotenv.config(); // Reads the .env file and makes variables like DISCORD_TOKEN available

//Set up Express web server
const app = express();            // Create a new Express app
app.get('/', (req, res) => res.send('Bot is running!')); // Responds with text when URL is visited
...
/* --- Why this matters ---
Render free instances require an open port to keep the instance “active”.
...
// 3. Optional: UptimeRobot pings the Express server → keeps the instance online 24/7.
